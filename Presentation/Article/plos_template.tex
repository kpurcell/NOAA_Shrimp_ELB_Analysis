...
% This paragraph was commented out due the model changing and removing annual area of hypoxia
% without that variable in the model this comparison is impossible.  
